...
def main():
  ...
  plistpath = scriptpath + "/resources/TestAAXParams-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestAAXParams-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestAAXParams-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestAAXParams-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestAAXParams-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestAAXParams-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/TestAAXParams-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/TestAAXParams.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TestAAXParams.iss",inplace=1):
