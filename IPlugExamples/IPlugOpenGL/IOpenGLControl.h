#ifndef __IOPENGLCONTROL__
#define __IOPENGLCONTROL__
...
class IOpenGLControl : public IControl
{
private:
  ...
  LICE_MemBitmap m_bmp;
  float mRotateTri, mRotateQuad;

public:
  IOpenGLControl(IPlugBase* pPlug, IRECT pR);
  ~IOpenGLControl();
  bool Draw(IGraphics* pGraphics);
  void DrawGL();
