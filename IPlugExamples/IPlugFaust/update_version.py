...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugFaust-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaust-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaust-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaust-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaust-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaust-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugFaust-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugFaust.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugFaust.iss",inplace=1):
